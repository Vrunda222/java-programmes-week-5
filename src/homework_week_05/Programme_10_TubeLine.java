...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        for (String s : tubeStationZone1) {
            if (userTubeStation.equalsIgnoreCase(s)) {
                catchStationName = s;
            }
        }
        ...
        if (userTubeStation.equalsIgnoreCase(catchStationName)) {
            ...
            for (String[] londonUGLine : londonUGLines) {
                for (int y = 1; y < tubeStationZone1.length; y++) {
                    String match = londonUGLine[y];
                    //System.out.println("I am here Line : 176" + match); //for debug purpose
                    if (userTubeStation.equalsIgnoreCase(match)) {
                        System.out.println(londonUGLine[0]); // first elements of multi dimension array is the line name
                    }
                }
            }
        } else {
